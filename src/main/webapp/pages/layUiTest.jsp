...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        <button class="layui-btn layui-btn-sm" lay-event="getMyData">查看个人信息</button>
        <button class="layui-btn layui-btn-sm" lay-event="upLoad">我要上传</button>
        <button class="layui-btn layui-btn-sm" lay-event="downLoad">我要下载</button>
    </div>
</script>
